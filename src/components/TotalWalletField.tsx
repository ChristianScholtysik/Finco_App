...
// //       </div>
// //       <div>
// //       if(!account && balance === null){<button>Add Account</button>}else{}
// //       </div>
...
//   });
//   const [balance, setBalance] = useState<number | null>(null);
//   const [_account, setAccount] = useState<number | null>(null);
...
//   useEffect(() => {
//     const updatedAccount = userContext.account?.amount;
//     setAccount(updatedAccount ?? 0);
//   }, [userContext.account]);
...
const TotalWalletField: React.FC<TotalWalletFieldProps> = ({ onToggle }) => {
  ...
  useEffect(() => {
    const updatedBalance = account?.amount ?? 0;
