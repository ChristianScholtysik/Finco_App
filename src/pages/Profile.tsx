...
//   const [avatarUrl, setAvatarUrl] = useState<string | null>(userContext?.profile?.avatar_url || null); 
...
//     if (!fileName) {
//       console.error("Invalid file path. Cannot extract file name.");
//       setIsDeleting(false);
//       return;
//     }
...
//     if (updateProfilesResponse.error) {
//       console.error(
//         "Error removing avatar URL from profile",
//         updateProfilesResponse.error.message
//       );
//       setIsDeleting(false);
//       return;
...
const Profile = () => {
  ...
  const [avatarFile, setAvatarFile] = useState<File | null>(null);
  const [avatarUrl, setAvatarUrl] = useState<string | null>(userContext?.profile?.avatar_url || null); // Initialize with current avatar URL
  const [uploading, setUploading] = useState<boolean>(false);
  const [isDeleting, setIsDeleting] = useState<boolean>(false);
